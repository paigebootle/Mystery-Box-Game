...
class Start:
    def __init__(self):
        ...
        self.mystery_instructions = Label(self.start_frame, font="Arial 10 italic",
                                          ...
                                          "button and choose the stakes. The "
    ...
    def check_funds(self):
        ...
        # set error background colours and assume no errors at start
        error_back = "#ffafaf"
        has_errors = "no"
        ...
        if has_errors == "yes":
            ...
            # set starting balance to amount set by user
